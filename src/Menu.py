...
class Menu:
    ...
    def draw(self):
        ...
        if self.is_instruction:
            ...
            arcade.draw_text("Food that gives speed boost for 5 seconds to your opponent. Stacks two times", self.center - 160, self.high-90, arcade.color.WHITE, 15, align="left", anchor_x="left")
            arcade.draw_text("Food that slow down your opponent for 5 seconds. Stacks up to 3 times", self.center - 160, self.high-120, arcade.color.WHITE, 15, align="left", anchor_x="left")
